...
- `python3`
- `bc`
- Python-пакеты `pandas` и `matplotlib`
...
Скрипт создаёт воспроизводимые входные данные, выполняет по 10 запусков
сжатия и распаковки для каждого файла и строит графики по результатам.
Пакеты для анализа можно установить, например, так:
